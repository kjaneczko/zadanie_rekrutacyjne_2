...
class LoginController extends Component {
    ...
    componentDidMount() {
        ...
        if (state) {
            ...
            this.setState((prevState) => ({isLoggedIn: AppState.isLoggedIn, user: AppState.user}));
        }
        if(AppState.isLoggedIn) {
            return this.props.history.push({ pathname: '/dashboard' });
        }
        console.log('LoginController - componentDidMount, AppState', AppState, this.state);
    }
            ...
            <div className="container">
                <div className="row">
                    <div className="offset-xl-3 col-xl-6 offset-lg-1 col-lg-10 col-md-12 col-sm-12 col-12 ">
                        ...
                        {this.state.error && !this.state.isLoggedIn ?
                            <FlashMessage duration={100000} persistOnHover={true}>
                                <h5 className={"alert alert-danger"}>Error: {this.state.error}</h5>
                            </FlashMessage> : ''}
